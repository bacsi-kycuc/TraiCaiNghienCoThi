...
export default function PromptCard({
  ...
  let formattedPlotUrl = "";
  if (prompt.plot && prompt.plot.trim()) {
    formattedPlotUrl = prompt.plot.trim();
    if (!/^https?:\/\//i.test(formattedPlotUrl)) {
      formattedPlotUrl = `https://${formattedPlotUrl}`;
    }
  }
